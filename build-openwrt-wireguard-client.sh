#!/usr/bin/env bash
# Build an OpenWrt WireGuard client gateway and package it as an OVA.
...
disk_dir='disk'
keys_dir='keys'
network_file="${project_dir}/networks/client.conf"
ova_file=''
ssh_port='22222'
luci_port='8080'
boot_timeout='180'
...
<ovf:Envelope xmlns:ovf="http://schemas.dmtf.org/ovf/envelope/1" xmlns:rasd="http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/CIM_ResourceAllocationSettingData" xmlns:vssd="http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/CIM_VirtualSystemSettingData" xmlns:vmw="http://www.vmware.com/schema/ovf">
  ...
  <ovf:VirtualSystem ovf:id="OpenWrt-WireGuard-Client">
    <ovf:Info>OpenWrt WireGuard client gateway</ovf:Info>
    <ovf:Name>OpenWrt WireGuard Client</ovf:Name>
    ...
    <ovf:VirtualHardwareSection>
      ...
      <ovf:System><vssd:ElementName>Virtual Hardware Family</vssd:ElementName><vssd:InstanceID>0</vssd:InstanceID><vssd:VirtualSystemIdentifier>OpenWrt WireGuard Client</vssd:VirtualSystemIdentifier><vssd:VirtualSystemType>virtualbox-2.2</vssd:VirtualSystemType></ovf:System>
